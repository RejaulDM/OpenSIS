...
class LatterGradeController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    //InputFinalGrade/addUpdateStudentFinalGrade
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! LatterGradeCell
...
extension LatterGradeController{
