//
//  MissingAttendanceListController.swift
//  OpenSIS
//
...
class MissingAttendanceListController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    
    @IBOutlet weak var lblHeadreName: UILabel!
    
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var lblDate: UILabel!
    @IBOutlet weak var lblMSG: UIView!
    ...
    let storeCourseSectionName = UserDefaults.standard.string(forKey: "Key_CourseSectionName") ?? ""
    ...
    let storeCourseSectionId = UserDefaults.standard.string(forKey: "Key_AttCourseSectionId") ?? ""
    ...
    override func viewDidLoad() {
        ...
        lblHeadreName.text! = storeCourseSectionName
        lblDate.text! = StoreAttDate
        ...
        lblMSG.layer.cornerRadius = 4
        lblMSG.layer.borderWidth = 1
        lblMSG.layer.borderColor = #colorLiteral(red: 1, green: 0.231372549, blue: 0.1882352941, alpha: 1)
    ...
    @IBAction func btnBack(_ sender: Any) {
        let storyboard = UIStoryboard(name: "Dashboard", bundle: nil)
         let contollerName = storyboard.instantiateViewController(withIdentifier: "NotificationMissingAttendanceController")
         self.present(contollerName, animated: true, completion: nil)
    }
    
    @IBAction func btnSubmite(_ sender: Any) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! MissingAttendanceListCell
        ...
        cell.lblName.text = firstGivenName + " " + lastFamilyName
...
extension MissingAttendanceListController: BtnAttStatusMiss {
...
extension MissingAttendanceListController:BtnMSGMiss {
...
extension MissingAttendanceListController{
    ...
    func callAPIGetAttendanceList(){
        ...
        let parameters = [
            ...
            "profilePhoto":true,
            "attendanceDate": StoreAttDate,//"2023-05-08",
            "_tenantName":storeTenantName,
            "_userName":storeName,
            "_token":storeToken,
            "tenantId":storeTenantID,
        ...
        print("Param Attendance list==",parameters)
        let jsonData = try! JSONSerialization.data(withJSONObject: parameters, options: JSONSerialization.WritingOptions.prettyPrinted)
