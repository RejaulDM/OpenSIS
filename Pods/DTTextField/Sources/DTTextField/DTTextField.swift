...
public class DTTextField: UITextField {
    ...
    fileprivate let paddingHeight:CGFloat                   = 2.0
    ...
    public var floatPlaceholderFont = UIFont.systemFont(ofSize: 17.0){
        didSet{
    ...
    public var borderColor:UIColor = #colorLiteral(red: 0.5808190107, green: 0.0884276256, blue: 0.3186392188, alpha: 0)
    ...
    fileprivate func commonInit() {
        ...
        floatPlaceholderColor       = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            //UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0)
        floatPlaceholderActiveColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
